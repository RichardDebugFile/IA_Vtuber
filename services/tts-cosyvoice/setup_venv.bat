...
:: Nota: numpy 1.26.4, transformers 4.51.3 - requiere venv separado

setlocal
set "SERVICE_DIR=%~dp0"
set "VENV_DIR=%SERVICE_DIR%venv"
set "SRC_VENV=D:\ExperimentosPython\TTS-Google\CosyVoice\venv"

echo ============================================================
echo  TTS CosyVoice3 - Setup del Venv Local
echo ============================================================
...
if exist "%SRC_VENV%\Scripts\python.exe" (
    echo Copiando venv desde disco D: (~8 GB, puede tardar 1-2 min)...
